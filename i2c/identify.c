...
#define  CH32V2_MARCHID     0xdc68d882		// Identifiers for CH32V203
#define  CH32V2_MVENDORID   0x00000000		// Identifiers for CH32V203

#define  CH32V3_MARCHID     0xdc68d881		// Identifiers for CH32V303
#define  CH32V3_MVENDORID   0x00000000		// Identifiers for CH32V303
...
char * mcuid(){
	if (read_csr(marchid) == GD32_MARCHID && read_csr(mvendorid) == GD32_MVENDORID)
		return "GD32VF103";
	if (read_csr(marchid) == CH32V1_MARCHID && read_csr(mvendorid) == CH32V1_MVENDORID)
			return "CH32V103";
	if (read_csr(marchid) == CH32V2_MARCHID && read_csr(mvendorid) == CH32V2_MVENDORID)
			return "CH32V203";
	if (read_csr(marchid) == CH32V3_MARCHID && read_csr(mvendorid) == CH32V3_MVENDORID)
			return "CH32V307";
	return "Unkown";
}
